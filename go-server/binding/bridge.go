...
// DepositRecords is a free data retrieval call binding the contract method 0x90320047.
//
// Solidity: function depositRecords(uint8 , uint256 ) view returns(uint256 destinationChainId, address sender, bytes32 resourceID, bytes data)
func (_Bridge *BridgeCaller) DepositRecords(opts *bind.CallOpts, arg0 uint8, arg1 *big.Int) (struct {
...
//
// Solidity: function depositRecords(uint8 , uint256 ) view returns(uint256 destinationChainId, address sender, bytes32 resourceID, bytes data)
func (_Bridge *BridgeSession) DepositRecords(arg0 uint8, arg1 *big.Int) (struct {
	DestinationChainId *big.Int
	Sender             common.Address
	ResourceID         [32]byte
	Data               []byte
...
//
// Solidity: function depositRecords(uint8 , uint256 ) view returns(uint256 destinationChainId, address sender, bytes32 resourceID, bytes data)
func (_Bridge *BridgeCallerSession) DepositRecords(arg0 uint8, arg1 *big.Int) (struct {
	DestinationChainId *big.Int
	Sender             common.Address
	ResourceID         [32]byte
	Data               []byte
...
// GetToeknInfoByResourceId is a free data retrieval call binding the contract method 0xc9185da2.
//
// Solidity: function getToeknInfoByResourceId(bytes32 resourceID) view returns(uint256, address, bool)
func (_Bridge *BridgeCaller) GetToeknInfoByResourceId(opts *bind.CallOpts, resourceID [32]byte) (*big.Int, common.Address, bool, error) {
	var out []interface{}
	err := _Bridge.contract.Call(opts, &out, "getToeknInfoByResourceId", resourceID)
...
//
// Solidity: function getToeknInfoByResourceId(bytes32 resourceID) view returns(uint256, address, bool)
func (_Bridge *BridgeSession) GetToeknInfoByResourceId(resourceID [32]byte) (*big.Int, common.Address, bool, error) {
	return _Bridge.Contract.GetToeknInfoByResourceId(&_Bridge.CallOpts, resourceID)
}

// GetToeknInfoByResourceId is a free data retrieval call binding the contract method 0xc9185da2.
//
// Solidity: function getToeknInfoByResourceId(bytes32 resourceID) view returns(uint256, address, bool)
func (_Bridge *BridgeCallerSession) GetToeknInfoByResourceId(resourceID [32]byte) (*big.Int, common.Address, bool, error) {
	return _Bridge.Contract.GetToeknInfoByResourceId(&_Bridge.CallOpts, resourceID)
}
...
// ResourceIdToExecuteSig is a free data retrieval call binding the contract method 0x20dae5db.
//
// Solidity: function resourceIdToExecuteSig(bytes32 ) view returns(bytes4)
func (_Bridge *BridgeCaller) ResourceIdToExecuteSig(opts *bind.CallOpts, arg0 [32]byte) ([4]byte, error) {
	var out []interface{}
	err := _Bridge.contract.Call(opts, &out, "resourceIdToExecuteSig", arg0)
...
//
// Solidity: function resourceIdToExecuteSig(bytes32 ) view returns(bytes4)
func (_Bridge *BridgeSession) ResourceIdToExecuteSig(arg0 [32]byte) ([4]byte, error) {
	return _Bridge.Contract.ResourceIdToExecuteSig(&_Bridge.CallOpts, arg0)
}

// ResourceIdToExecuteSig is a free data retrieval call binding the contract method 0x20dae5db.
//
// Solidity: function resourceIdToExecuteSig(bytes32 ) view returns(bytes4)
func (_Bridge *BridgeCallerSession) ResourceIdToExecuteSig(arg0 [32]byte) ([4]byte, error) {
	return _Bridge.Contract.ResourceIdToExecuteSig(&_Bridge.CallOpts, arg0)
}
...
// AdminSetEnv is a paid mutator transaction binding the contract method 0x53819314.
//
// Solidity: function adminSetEnv(address voteAddress_, uint256 chainId_) returns()
func (_Bridge *BridgeTransactor) AdminSetEnv(opts *bind.TransactOpts, voteAddress_ common.Address, chainId_ *big.Int) (*types.Transaction, error) {
	return _Bridge.contract.Transact(opts, "adminSetEnv", voteAddress_, chainId_)
}

// AdminSetEnv is a paid mutator transaction binding the contract method 0x53819314.
//
// Solidity: function adminSetEnv(address voteAddress_, uint256 chainId_) returns()
func (_Bridge *BridgeSession) AdminSetEnv(voteAddress_ common.Address, chainId_ *big.Int) (*types.Transaction, error) {
	return _Bridge.Contract.AdminSetEnv(&_Bridge.TransactOpts, voteAddress_, chainId_)
}

// AdminSetEnv is a paid mutator transaction binding the contract method 0x53819314.
//
// Solidity: function adminSetEnv(address voteAddress_, uint256 chainId_) returns()
func (_Bridge *BridgeTransactorSession) AdminSetEnv(voteAddress_ common.Address, chainId_ *big.Int) (*types.Transaction, error) {
	return _Bridge.Contract.AdminSetEnv(&_Bridge.TransactOpts, voteAddress_, chainId_)
}

// AdminSetResource is a paid mutator transaction binding the contract method 0xfd2f4647.
//
// Solidity: function adminSetResource(bytes32 resourceID, uint8 assetsType, address tokenAddress, uint256 fee, bool pause, address tantinAddress, bytes4 executeFunctionSig) returns()
func (_Bridge *BridgeTransactor) AdminSetResource(opts *bind.TransactOpts, resourceID [32]byte, assetsType uint8, tokenAddress common.Address, fee *big.Int, pause bool, tantinAddress common.Address, executeFunctionSig [4]byte) (*types.Transaction, error) {
	return _Bridge.contract.Transact(opts, "adminSetResource", resourceID, assetsType, tokenAddress, fee, pause, tantinAddress, executeFunctionSig)
}

// AdminSetResource is a paid mutator transaction binding the contract method 0xfd2f4647.
//
// Solidity: function adminSetResource(bytes32 resourceID, uint8 assetsType, address tokenAddress, uint256 fee, bool pause, address tantinAddress, bytes4 executeFunctionSig) returns()
func (_Bridge *BridgeSession) AdminSetResource(resourceID [32]byte, assetsType uint8, tokenAddress common.Address, fee *big.Int, pause bool, tantinAddress common.Address, executeFunctionSig [4]byte) (*types.Transaction, error) {
	return _Bridge.Contract.AdminSetResource(&_Bridge.TransactOpts, resourceID, assetsType, tokenAddress, fee, pause, tantinAddress, executeFunctionSig)
}

// AdminSetResource is a paid mutator transaction binding the contract method 0xfd2f4647.
//
// Solidity: function adminSetResource(bytes32 resourceID, uint8 assetsType, address tokenAddress, uint256 fee, bool pause, address tantinAddress, bytes4 executeFunctionSig) returns()
func (_Bridge *BridgeTransactorSession) AdminSetResource(resourceID [32]byte, assetsType uint8, tokenAddress common.Address, fee *big.Int, pause bool, tantinAddress common.Address, executeFunctionSig [4]byte) (*types.Transaction, error) {
	return _Bridge.Contract.AdminSetResource(&_Bridge.TransactOpts, resourceID, assetsType, tokenAddress, fee, pause, tantinAddress, executeFunctionSig)
}
...
// Execute is a paid mutator transaction binding the contract method 0xc5bfcb57.
//
// Solidity: function execute(uint256 originChainId, bytes32 resourceId, uint256 originDepositNonce, bytes data) returns()
func (_Bridge *BridgeTransactor) Execute(opts *bind.TransactOpts, originChainId *big.Int, resourceId [32]byte, originDepositNonce *big.Int, data []byte) (*types.Transaction, error) {
	return _Bridge.contract.Transact(opts, "execute", originChainId, resourceId, originDepositNonce, data)
}

// Execute is a paid mutator transaction binding the contract method 0xc5bfcb57.
//
// Solidity: function execute(uint256 originChainId, bytes32 resourceId, uint256 originDepositNonce, bytes data) returns()
func (_Bridge *BridgeSession) Execute(originChainId *big.Int, resourceId [32]byte, originDepositNonce *big.Int, data []byte) (*types.Transaction, error) {
	return _Bridge.Contract.Execute(&_Bridge.TransactOpts, originChainId, resourceId, originDepositNonce, data)
}

// Execute is a paid mutator transaction binding the contract method 0xc5bfcb57.
//
// Solidity: function execute(uint256 originChainId, bytes32 resourceId, uint256 originDepositNonce, bytes data) returns()
func (_Bridge *BridgeTransactorSession) Execute(originChainId *big.Int, resourceId [32]byte, originDepositNonce *big.Int, data []byte) (*types.Transaction, error) {
	return _Bridge.Contract.Execute(&_Bridge.TransactOpts, originChainId, resourceId, originDepositNonce, data)
}
...
// FilterSetResource is a free log retrieval operation binding the contract event 0x0bad183d9181d13c95cc8e61eaf98bd009bbc9c7d637b3eeac4a2020f9893f33.
//
// Solidity: event SetResource(bytes32 indexed resourceID, address tokenAddress, uint256 fee, bool pause, address tantinAddress, bytes4 executeFunctionSig)
...
// WatchSetResource is a free log subscription operation binding the contract event 0x0bad183d9181d13c95cc8e61eaf98bd009bbc9c7d637b3eeac4a2020f9893f33.
//
// Solidity: event SetResource(bytes32 indexed resourceID, address tokenAddress, uint256 fee, bool pause, address tantinAddress, bytes4 executeFunctionSig)
...
// ParseSetResource is a log parse operation binding the contract event 0x0bad183d9181d13c95cc8e61eaf98bd009bbc9c7d637b3eeac4a2020f9893f33.
//
// Solidity: event SetResource(bytes32 indexed resourceID, address tokenAddress, uint256 fee, bool pause, address tantinAddress, bytes4 executeFunctionSig)
