...
func (_Bridge *BridgeCaller) SigNonce(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Bridge.contract.Call(opts, &out, "sigNonce")
...
//
// Solidity: function sigNonce() view returns(uint256)
func (_Bridge *BridgeSession) SigNonce() (*big.Int, error) {
	return _Bridge.Contract.SigNonce(&_Bridge.CallOpts)
}

// SigNonce is a free data retrieval call binding the contract method 0xcd868c9c.
//
// Solidity: function sigNonce() view returns(uint256)
func (_Bridge *BridgeCallerSession) SigNonce() (*big.Int, error) {
	return _Bridge.Contract.SigNonce(&_Bridge.CallOpts)
}
...
// AdminPauseTransfers is a paid mutator transaction binding the contract method 0xa895d35b.
//
// Solidity: function adminPauseTransfers(bytes signature) returns()
func (_Bridge *BridgeTransactor) AdminPauseTransfers(opts *bind.TransactOpts, signature []byte) (*types.Transaction, error) {
	return _Bridge.contract.Transact(opts, "adminPauseTransfers", signature)
}

// AdminPauseTransfers is a paid mutator transaction binding the contract method 0xa895d35b.
//
// Solidity: function adminPauseTransfers(bytes signature) returns()
func (_Bridge *BridgeSession) AdminPauseTransfers(signature []byte) (*types.Transaction, error) {
	return _Bridge.Contract.AdminPauseTransfers(&_Bridge.TransactOpts, signature)
}

// AdminPauseTransfers is a paid mutator transaction binding the contract method 0xa895d35b.
//
// Solidity: function adminPauseTransfers(bytes signature) returns()
func (_Bridge *BridgeTransactorSession) AdminPauseTransfers(signature []byte) (*types.Transaction, error) {
	return _Bridge.Contract.AdminPauseTransfers(&_Bridge.TransactOpts, signature)
}

// AdminSetEnv is a paid mutator transaction binding the contract method 0x7aac640e.
//
// Solidity: function adminSetEnv(address voteAddress_, bytes signature_) returns()
func (_Bridge *BridgeTransactor) AdminSetEnv(opts *bind.TransactOpts, voteAddress_ common.Address, signature_ []byte) (*types.Transaction, error) {
	return _Bridge.contract.Transact(opts, "adminSetEnv", voteAddress_, signature_)
}

// AdminSetEnv is a paid mutator transaction binding the contract method 0x7aac640e.
//
// Solidity: function adminSetEnv(address voteAddress_, bytes signature_) returns()
func (_Bridge *BridgeSession) AdminSetEnv(voteAddress_ common.Address, signature_ []byte) (*types.Transaction, error) {
	return _Bridge.Contract.AdminSetEnv(&_Bridge.TransactOpts, voteAddress_, signature_)
}

// AdminSetEnv is a paid mutator transaction binding the contract method 0x7aac640e.
//
// Solidity: function adminSetEnv(address voteAddress_, bytes signature_) returns()
func (_Bridge *BridgeTransactorSession) AdminSetEnv(voteAddress_ common.Address, signature_ []byte) (*types.Transaction, error) {
	return _Bridge.Contract.AdminSetEnv(&_Bridge.TransactOpts, voteAddress_, signature_)
}

// AdminSetResource is a paid mutator transaction binding the contract method 0x9cbbfa2f.
//
// Solidity: function adminSetResource(bytes32 resourceID, uint8 assetsType, address tokenAddress, uint256 decimal, uint256 fee, bool pause, bool burnable, bool mintable, bytes signature) returns()
func (_Bridge *BridgeTransactor) AdminSetResource(opts *bind.TransactOpts, resourceID [32]byte, assetsType uint8, tokenAddress common.Address, decimal *big.Int, fee *big.Int, pause bool, burnable bool, mintable bool, signature []byte) (*types.Transaction, error) {
	return _Bridge.contract.Transact(opts, "adminSetResource", resourceID, assetsType, tokenAddress, decimal, fee, pause, burnable, mintable, signature)
}

// AdminSetResource is a paid mutator transaction binding the contract method 0x9cbbfa2f.
//
// Solidity: function adminSetResource(bytes32 resourceID, uint8 assetsType, address tokenAddress, uint256 decimal, uint256 fee, bool pause, bool burnable, bool mintable, bytes signature) returns()
func (_Bridge *BridgeSession) AdminSetResource(resourceID [32]byte, assetsType uint8, tokenAddress common.Address, decimal *big.Int, fee *big.Int, pause bool, burnable bool, mintable bool, signature []byte) (*types.Transaction, error) {
	return _Bridge.Contract.AdminSetResource(&_Bridge.TransactOpts, resourceID, assetsType, tokenAddress, decimal, fee, pause, burnable, mintable, signature)
}

// AdminSetResource is a paid mutator transaction binding the contract method 0x9cbbfa2f.
//
// Solidity: function adminSetResource(bytes32 resourceID, uint8 assetsType, address tokenAddress, uint256 decimal, uint256 fee, bool pause, bool burnable, bool mintable, bytes signature) returns()
func (_Bridge *BridgeTransactorSession) AdminSetResource(resourceID [32]byte, assetsType uint8, tokenAddress common.Address, decimal *big.Int, fee *big.Int, pause bool, burnable bool, mintable bool, signature []byte) (*types.Transaction, error) {
	return _Bridge.Contract.AdminSetResource(&_Bridge.TransactOpts, resourceID, assetsType, tokenAddress, decimal, fee, pause, burnable, mintable, signature)
}

// AdminUnpauseTransfers is a paid mutator transaction binding the contract method 0x8f53d4a1.
//
// Solidity: function adminUnpauseTransfers(bytes signature) returns()
func (_Bridge *BridgeTransactor) AdminUnpauseTransfers(opts *bind.TransactOpts, signature []byte) (*types.Transaction, error) {
	return _Bridge.contract.Transact(opts, "adminUnpauseTransfers", signature)
}

// AdminUnpauseTransfers is a paid mutator transaction binding the contract method 0x8f53d4a1.
//
// Solidity: function adminUnpauseTransfers(bytes signature) returns()
func (_Bridge *BridgeSession) AdminUnpauseTransfers(signature []byte) (*types.Transaction, error) {
	return _Bridge.Contract.AdminUnpauseTransfers(&_Bridge.TransactOpts, signature)
}

// AdminUnpauseTransfers is a paid mutator transaction binding the contract method 0x8f53d4a1.
//
// Solidity: function adminUnpauseTransfers(bytes signature) returns()
func (_Bridge *BridgeTransactorSession) AdminUnpauseTransfers(signature []byte) (*types.Transaction, error) {
	return _Bridge.Contract.AdminUnpauseTransfers(&_Bridge.TransactOpts, signature)
}
...
// FilterSetResource is a free log retrieval operation binding the contract event 0x3e3428d4923be6feff5174d43daaaeb53b0fc08375b61eb9a0bc2eedea8c7aa6.
//
// Solidity: event SetResource(bytes32 indexed resourceID, address tokenAddress, uint256 decimal, uint256 fee, bool pause, bool burnable, bool mintable)
...
// WatchSetResource is a free log subscription operation binding the contract event 0x3e3428d4923be6feff5174d43daaaeb53b0fc08375b61eb9a0bc2eedea8c7aa6.
//
// Solidity: event SetResource(bytes32 indexed resourceID, address tokenAddress, uint256 decimal, uint256 fee, bool pause, bool burnable, bool mintable)
...
// ParseSetResource is a log parse operation binding the contract event 0x3e3428d4923be6feff5174d43daaaeb53b0fc08375b61eb9a0bc2eedea8c7aa6.
//
// Solidity: event SetResource(bytes32 indexed resourceID, address tokenAddress, uint256 decimal, uint256 fee, bool pause, bool burnable, bool mintable)
