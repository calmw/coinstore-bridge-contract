...
// ITantinBridgeDepositRecord is an auto generated low-level Go binding around an user-defined struct.
type ITantinBridgeDepositRecord struct {
...
// CheckDepositSignature2 is a free data retrieval call binding the contract method 0x83fb4525.
//
// Solidity: function checkDepositSignature2(bytes signature, address recipient) pure returns(address)
func (_Tantin *TantinCaller) CheckDepositSignature2(opts *bind.CallOpts, signature []byte, recipient common.Address) (common.Address, error) {
	var out []interface{}
	err := _Tantin.contract.Call(opts, &out, "checkDepositSignature2", signature, recipient)
...
//
// Solidity: function checkDepositSignature2(bytes signature, address recipient) pure returns(address)
func (_Tantin *TantinSession) CheckDepositSignature2(signature []byte, recipient common.Address) (common.Address, error) {
	return _Tantin.Contract.CheckDepositSignature2(&_Tantin.CallOpts, signature, recipient)
}

// CheckDepositSignature2 is a free data retrieval call binding the contract method 0x83fb4525.
//
// Solidity: function checkDepositSignature2(bytes signature, address recipient) pure returns(address)
func (_Tantin *TantinCallerSession) CheckDepositSignature2(signature []byte, recipient common.Address) (common.Address, error) {
	return _Tantin.Contract.CheckDepositSignature2(&_Tantin.CallOpts, signature, recipient)
}
...
func (_Tantin *TantinCaller) GetDepositRecord(opts *bind.CallOpts, user_ common.Address, userDepositNonce_ *big.Int) (ITantinBridgeDepositRecord, error) {
	...
	if err != nil {
		return *new(ITantinBridgeDepositRecord), err
	}

	out0 := *abi.ConvertType(out[0], new(ITantinBridgeDepositRecord)).(*ITantinBridgeDepositRecord)
...
//
// Solidity: function resourceIdToTokenInfo(bytes32 ) view returns(uint8 assetsType, address tokenAddress, bool burnable, bool mintable, bool pause)
func (_Tantin *TantinCaller) ResourceIdToTokenInfo(opts *bind.CallOpts, arg0 [32]byte) (struct {
	AssetsType   uint8
	TokenAddress common.Address
	Burnable     bool
	Mintable     bool
	...
	var out []interface{}
	err := _Tantin.contract.Call(opts, &out, "resourceIdToTokenInfo", arg0)
	...
	outstruct.Burnable = *abi.ConvertType(out[2], new(bool)).(*bool)
	outstruct.Mintable = *abi.ConvertType(out[3], new(bool)).(*bool)
	outstruct.Pause = *abi.ConvertType(out[4], new(bool)).(*bool)
...
//
// Solidity: function resourceIdToTokenInfo(bytes32 ) view returns(uint8 assetsType, address tokenAddress, bool burnable, bool mintable, bool pause)
func (_Tantin *TantinSession) ResourceIdToTokenInfo(arg0 [32]byte) (struct {
	AssetsType   uint8
	TokenAddress common.Address
	Burnable     bool
	Mintable     bool
	...
	return _Tantin.Contract.ResourceIdToTokenInfo(&_Tantin.CallOpts, arg0)
}

// ResourceIdToTokenInfo is a free data retrieval call binding the contract method 0x6cbfe81f.
//
// Solidity: function resourceIdToTokenInfo(bytes32 ) view returns(uint8 assetsType, address tokenAddress, bool burnable, bool mintable, bool pause)
func (_Tantin *TantinCallerSession) ResourceIdToTokenInfo(arg0 [32]byte) (struct {
	AssetsType   uint8
	TokenAddress common.Address
	Burnable     bool
	Mintable     bool
...
func (_Tantin *TantinTransactor) AdminAddBlacklist(opts *bind.TransactOpts, user common.Address) (*types.Transaction, error) {
	return _Tantin.contract.Transact(opts, "adminAddBlacklist", user)
}

// AdminAddBlacklist is a paid mutator transaction binding the contract method 0x456d32fa.
//
// Solidity: function adminAddBlacklist(address user) returns()
func (_Tantin *TantinSession) AdminAddBlacklist(user common.Address) (*types.Transaction, error) {
	return _Tantin.Contract.AdminAddBlacklist(&_Tantin.TransactOpts, user)
}

// AdminAddBlacklist is a paid mutator transaction binding the contract method 0x456d32fa.
//
// Solidity: function adminAddBlacklist(address user) returns()
func (_Tantin *TantinTransactorSession) AdminAddBlacklist(user common.Address) (*types.Transaction, error) {
	return _Tantin.Contract.AdminAddBlacklist(&_Tantin.TransactOpts, user)
}

// AdminRemoveBlacklist is a paid mutator transaction binding the contract method 0xd756f2a5.
//
// Solidity: function adminRemoveBlacklist(address user) returns()
func (_Tantin *TantinTransactor) AdminRemoveBlacklist(opts *bind.TransactOpts, user common.Address) (*types.Transaction, error) {
	return _Tantin.contract.Transact(opts, "adminRemoveBlacklist", user)
}

// AdminRemoveBlacklist is a paid mutator transaction binding the contract method 0xd756f2a5.
//
// Solidity: function adminRemoveBlacklist(address user) returns()
func (_Tantin *TantinSession) AdminRemoveBlacklist(user common.Address) (*types.Transaction, error) {
	return _Tantin.Contract.AdminRemoveBlacklist(&_Tantin.TransactOpts, user)
}

// AdminRemoveBlacklist is a paid mutator transaction binding the contract method 0xd756f2a5.
//
// Solidity: function adminRemoveBlacklist(address user) returns()
func (_Tantin *TantinTransactorSession) AdminRemoveBlacklist(user common.Address) (*types.Transaction, error) {
	return _Tantin.Contract.AdminRemoveBlacklist(&_Tantin.TransactOpts, user)
}

// AdminSetEnv is a paid mutator transaction binding the contract method 0xb39fced5.
//
// Solidity: function adminSetEnv(address bridgeAddress_) returns()
func (_Tantin *TantinTransactor) AdminSetEnv(opts *bind.TransactOpts, bridgeAddress_ common.Address) (*types.Transaction, error) {
	return _Tantin.contract.Transact(opts, "adminSetEnv", bridgeAddress_)
}

// AdminSetEnv is a paid mutator transaction binding the contract method 0xb39fced5.
//
// Solidity: function adminSetEnv(address bridgeAddress_) returns()
func (_Tantin *TantinSession) AdminSetEnv(bridgeAddress_ common.Address) (*types.Transaction, error) {
	return _Tantin.Contract.AdminSetEnv(&_Tantin.TransactOpts, bridgeAddress_)
}

// AdminSetEnv is a paid mutator transaction binding the contract method 0xb39fced5.
//
// Solidity: function adminSetEnv(address bridgeAddress_) returns()
func (_Tantin *TantinTransactorSession) AdminSetEnv(bridgeAddress_ common.Address) (*types.Transaction, error) {
	return _Tantin.Contract.AdminSetEnv(&_Tantin.TransactOpts, bridgeAddress_)
}

// AdminSetToken is a paid mutator transaction binding the contract method 0x7b105f92.
//
// Solidity: function adminSetToken(bytes32 resourceID, uint8 assetsType, address tokenAddress, bool burnable, bool mintable, bool pause) returns()
func (_Tantin *TantinTransactor) AdminSetToken(opts *bind.TransactOpts, resourceID [32]byte, assetsType uint8, tokenAddress common.Address, burnable bool, mintable bool, pause bool) (*types.Transaction, error) {
	return _Tantin.contract.Transact(opts, "adminSetToken", resourceID, assetsType, tokenAddress, burnable, mintable, pause)
}

// AdminSetToken is a paid mutator transaction binding the contract method 0x7b105f92.
//
// Solidity: function adminSetToken(bytes32 resourceID, uint8 assetsType, address tokenAddress, bool burnable, bool mintable, bool pause) returns()
func (_Tantin *TantinSession) AdminSetToken(resourceID [32]byte, assetsType uint8, tokenAddress common.Address, burnable bool, mintable bool, pause bool) (*types.Transaction, error) {
...
//
// Solidity: function adminSetToken(bytes32 resourceID, uint8 assetsType, address tokenAddress, bool burnable, bool mintable, bool pause) returns()
func (_Tantin *TantinTransactorSession) AdminSetToken(resourceID [32]byte, assetsType uint8, tokenAddress common.Address, burnable bool, mintable bool, pause bool) (*types.Transaction, error) {
	return _Tantin.Contract.AdminSetToken(&_Tantin.TransactOpts, resourceID, assetsType, tokenAddress, burnable, mintable, pause)
}
...
func (_Tantin *TantinTransactor) Execute(opts *bind.TransactOpts, data []byte) (*types.Transaction, error) {
	return _Tantin.contract.Transact(opts, "execute", data)
}

// Execute is a paid mutator transaction binding the contract method 0x09c5eabe.
//
// Solidity: function execute(bytes data) returns()
func (_Tantin *TantinSession) Execute(data []byte) (*types.Transaction, error) {
	return _Tantin.Contract.Execute(&_Tantin.TransactOpts, data)
}

// Execute is a paid mutator transaction binding the contract method 0x09c5eabe.
//
// Solidity: function execute(bytes data) returns()
func (_Tantin *TantinTransactorSession) Execute(data []byte) (*types.Transaction, error) {
	return _Tantin.Contract.Execute(&_Tantin.TransactOpts, data)
}
...
// TantinExecuteEventIterator is returned from FilterExecuteEvent and is used to iterate over the raw logs and unpacked data for ExecuteEvent events raised by the Tantin contract.
type TantinExecuteEventIterator struct {
	Event *TantinExecuteEvent // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *TantinExecuteEventIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(TantinExecuteEvent)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *TantinExecuteEventIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *TantinExecuteEventIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// TantinExecuteEvent represents a ExecuteEvent event raised by the Tantin contract.
type TantinExecuteEvent struct {
	Depositer          common.Address
	Recipient          common.Address
	Amount             *big.Int
	TokenAddress       common.Address
...
// FilterExecuteEvent is a free log retrieval operation binding the contract event 0xdd40a82b05465c41c39c0f644f8bf0f770d618584c79727cce444d6459c7ed34.
//
// Solidity: event ExecuteEvent(address indexed depositer, address indexed recipient, uint256 indexed amount, address tokenAddress, uint256 originDepositNonce, uint256 originChainId)
func (_Tantin *TantinFilterer) FilterExecuteEvent(opts *bind.FilterOpts, depositer []common.Address, recipient []common.Address, amount []*big.Int) (*TantinExecuteEventIterator, error) {
	...
	logs, sub, err := _Tantin.contract.FilterLogs(opts, "ExecuteEvent", depositerRule, recipientRule, amountRule)
	if err != nil {
		return nil, err
	}
	return &TantinExecuteEventIterator{contract: _Tantin.contract, event: "ExecuteEvent", logs: logs, sub: sub}, nil
}

// WatchExecuteEvent is a free log subscription operation binding the contract event 0xdd40a82b05465c41c39c0f644f8bf0f770d618584c79727cce444d6459c7ed34.
//
// Solidity: event ExecuteEvent(address indexed depositer, address indexed recipient, uint256 indexed amount, address tokenAddress, uint256 originDepositNonce, uint256 originChainId)
func (_Tantin *TantinFilterer) WatchExecuteEvent(opts *bind.WatchOpts, sink chan<- *TantinExecuteEvent, depositer []common.Address, recipient []common.Address, amount []*big.Int) (event.Subscription, error) {
	...
	logs, sub, err := _Tantin.contract.WatchLogs(opts, "ExecuteEvent", depositerRule, recipientRule, amountRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(TantinExecuteEvent)
				if err := _Tantin.contract.UnpackLog(event, "ExecuteEvent", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseExecuteEvent is a log parse operation binding the contract event 0xdd40a82b05465c41c39c0f644f8bf0f770d618584c79727cce444d6459c7ed34.
//
// Solidity: event ExecuteEvent(address indexed depositer, address indexed recipient, uint256 indexed amount, address tokenAddress, uint256 originDepositNonce, uint256 originChainId)
func (_Tantin *TantinFilterer) ParseExecuteEvent(log types.Log) (*TantinExecuteEvent, error) {
	event := new(TantinExecuteEvent)
	if err := _Tantin.contract.UnpackLog(event, "ExecuteEvent", log); err != nil {
		return nil, err
	}
