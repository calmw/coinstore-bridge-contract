...
// AdminSetEnv is a paid mutator transaction binding the contract method 0xb0ad669b.
//
// Solidity: function adminSetEnv(address feeAddress_, address serverAddress_, address bridgeAddress_, bytes signature_) returns()
func (_Tantin *TantinTransactor) AdminSetEnv(opts *bind.TransactOpts, feeAddress_ common.Address, serverAddress_ common.Address, bridgeAddress_ common.Address, signature_ []byte) (*types.Transaction, error) {
	return _Tantin.contract.Transact(opts, "adminSetEnv", feeAddress_, serverAddress_, bridgeAddress_, signature_)
}

// AdminSetEnv is a paid mutator transaction binding the contract method 0xb0ad669b.
//
// Solidity: function adminSetEnv(address feeAddress_, address serverAddress_, address bridgeAddress_, bytes signature_) returns()
func (_Tantin *TantinSession) AdminSetEnv(feeAddress_ common.Address, serverAddress_ common.Address, bridgeAddress_ common.Address, signature_ []byte) (*types.Transaction, error) {
	return _Tantin.Contract.AdminSetEnv(&_Tantin.TransactOpts, feeAddress_, serverAddress_, bridgeAddress_, signature_)
}

// AdminSetEnv is a paid mutator transaction binding the contract method 0xb0ad669b.
//
// Solidity: function adminSetEnv(address feeAddress_, address serverAddress_, address bridgeAddress_, bytes signature_) returns()
func (_Tantin *TantinTransactorSession) AdminSetEnv(feeAddress_ common.Address, serverAddress_ common.Address, bridgeAddress_ common.Address, signature_ []byte) (*types.Transaction, error) {
	return _Tantin.Contract.AdminSetEnv(&_Tantin.TransactOpts, feeAddress_, serverAddress_, bridgeAddress_, signature_)
}
...
// Deposit is a paid mutator transaction binding the contract method 0x7eb6c40f.
//
// Solidity: function deposit(uint256 destinationChainId, bytes32 resourceId, address recipient, uint256 amount, uint256 price, uint256 priceTimestamp, bytes priceSignature, bytes recipientSignature) payable returns()
func (_Tantin *TantinTransactor) Deposit(opts *bind.TransactOpts, destinationChainId *big.Int, resourceId [32]byte, recipient common.Address, amount *big.Int, price *big.Int, priceTimestamp *big.Int, priceSignature []byte, recipientSignature []byte) (*types.Transaction, error) {
	return _Tantin.contract.Transact(opts, "deposit", destinationChainId, resourceId, recipient, amount, price, priceTimestamp, priceSignature, recipientSignature)
}

// Deposit is a paid mutator transaction binding the contract method 0x7eb6c40f.
//
// Solidity: function deposit(uint256 destinationChainId, bytes32 resourceId, address recipient, uint256 amount, uint256 price, uint256 priceTimestamp, bytes priceSignature, bytes recipientSignature) payable returns()
func (_Tantin *TantinSession) Deposit(destinationChainId *big.Int, resourceId [32]byte, recipient common.Address, amount *big.Int, price *big.Int, priceTimestamp *big.Int, priceSignature []byte, recipientSignature []byte) (*types.Transaction, error) {
	return _Tantin.Contract.Deposit(&_Tantin.TransactOpts, destinationChainId, resourceId, recipient, amount, price, priceTimestamp, priceSignature, recipientSignature)
}

// Deposit is a paid mutator transaction binding the contract method 0x7eb6c40f.
//
// Solidity: function deposit(uint256 destinationChainId, bytes32 resourceId, address recipient, uint256 amount, uint256 price, uint256 priceTimestamp, bytes priceSignature, bytes recipientSignature) payable returns()
func (_Tantin *TantinTransactorSession) Deposit(destinationChainId *big.Int, resourceId [32]byte, recipient common.Address, amount *big.Int, price *big.Int, priceTimestamp *big.Int, priceSignature []byte, recipientSignature []byte) (*types.Transaction, error) {
	return _Tantin.Contract.Deposit(&_Tantin.TransactOpts, destinationChainId, resourceId, recipient, amount, price, priceTimestamp, priceSignature, recipientSignature)
}
